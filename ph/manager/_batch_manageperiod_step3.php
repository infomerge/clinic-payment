...
$sql = "SELECT * FROM acc_result as a inner join patient_info as b on a.original_pid = b.original_pid WHERE a.reqid is null AND b.rp_cid is not null and b.direct_debit = 0 and a.rp_disableflag = 0;";
