<?php
/**
 * 薬科システム接続設定（このファイルが単一の設定源）
 * DBNAME / DBHOST / DBUSER / DBPASS を変えれば、定数参照箇所へ反映される。
 */
define('DBNAME', 'xs547384_phdev');
define('DBHOST', 'localhost');
define('DBUSER', 'xs547384_dx');
define('DBPASS', 'wwxlkl7m');
define('COD_PREFIX', 'ph-'); # Robot Payment 店舗オーダー番号の接頭辞（result.php 振り分け用）
define('SERVICETITLE', 'PH クリニックペイメント（DEV）');
