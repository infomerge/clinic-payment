...
*}
        ...
        <th width="200">商品コード/商品名</th>
        
       
        <th width="200">対象パートナー</th>
        <th width="100">設定内容{*提供期間*}</th>
        ...
        *}
        ...
        <td width="150">{$item.product_code}<br />
<a href="product_master.php?product_id={$item.product_id}">{$item.product_name}</a></td>
        
        
        <td width="100">{if $item.client_id ne 0}{$m_partner[$item.client_id]}{/if}
        {$item.partner_name}
        </td>
        <td>
        <div>提供期間：{$item.term}</div>
        ...
        <td width="490">
        画面２：決済方法選択<br />
        <a href="http://charisma.media/e/product_purchase.php?product_id={$item.product_id}&step=select_payment">http://charisma.media/e/product_purchase.php?product_id={$item.product_id}&step=select_payment</a><br />
        画面３：入会案内<br />
        <a href="http://charisma.media/e/product_purchase.php?product_id={$item.product_id}&step=complete">http://charisma.media/e/product_purchase.php?product_id={$item.product_id}&step=complete</a>
        </td>
