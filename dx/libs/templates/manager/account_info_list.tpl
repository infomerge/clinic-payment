...
<br /><br />
        ...
        <td width="50">{$item.irkk_prefecture}</td>
        <td width="100">{$item.irkk_address1}</td>
        <td width="100">{$item.irkk_address2}</td>
        <td width="80">{$item.tel}</td>
        <td width="100">{$item.irkk_bank_name}</td>
        <td width="100">{$item.irkk_bank_branch}</td>
        <td width="20">{$item.irkk_bank_classification}</td>
        <td width="50">{$item.irkk_bank_no}</td>
