...
<div id="wrap">
    ...
    <h2 class="title_name">患者情報登録</h2>
        ...
        <form method="post">
            ...
            <td class="bg_odd">郵便番号：<input type="text" name="postal_code" value="{$data.postal_code}" class="frmtxt" style="width:100px;" onchange="AjaxZip3.zip2addr(this,'','prefecture','address1','address2');" /></td></tr>
            ...
            <td class="bg_odd">郵便番号：<input type="text" name="postal_code_sub" value="{$data.postal_code_sub}" class="frmtxt" style="width:100px;" onchange="AjaxZip3.zip2addr(this,'','prefecture_sub','address1_sub','address2_sub');" /></td></tr>
